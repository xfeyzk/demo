                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="content">
                                        <form method="POST" action="editNew.php">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Titulo</label>
                                                        <input type="text" class="form-control" name="titulo" value="<?php echo $N["titulo"];?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Subtitulo</label>
                                                        <input type="text" class="form-control" name="subtitulo" value="<?php echo $N["subtitulo"];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="circulo" value="<?php echo $N["imagen"];?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>URL Imagen Banner</label>
                                                        <input type="text" class="form-control" name="banner" value="<?php echo $N["banner"];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="p1" value="<?php echo $N["p1"];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="p2" value="<?php echo $N["p2"];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="p3" value="<?php echo $N["p3"];?>">
                                                    </div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="media" value='<?php echo $N['media'];?>'>
                                                    </div>
                                                </div>
